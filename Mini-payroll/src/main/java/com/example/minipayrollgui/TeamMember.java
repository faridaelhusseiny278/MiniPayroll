...
public class TeamMember extends Engineer {

    public TeamMember() {

    }

    public TeamMember (Grade grade,double workinghours){
        this.grade=grade;
        this.workingHours=workinghours;
    }
    public TeamMember(int id, String name, int age, double workingHours, Grade grade) {
        super(id, name, age, workingHours, grade);
    }


    public TeamMember(int id, String name, int age, double salary, double workingHours, Grade grade) {
